...
#quakes = read.csv('path/quakes.csv',header=TRUE,sep=",")
...
plot(earth_quakes$depth , type="l")# p:points, l:line,b:both

plot(earth_quakes$depth, xlab = 'depth concentration', 
          ylab = 'No of Insances',main= 'depth levels',col='blue')
